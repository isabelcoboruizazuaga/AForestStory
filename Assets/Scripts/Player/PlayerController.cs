...
public class PlayerController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        canvasJoystick = GameObject.Find("JoysCanvas");
        canvasJoystick.GetComponent<Canvas>().enabled = false;



#if UNITY_ANDROID

        canvasJoystick.GetComponent<Canvas>().enabled = true;

        //Botón salto android
        Button btn = saltoBtn.GetComponent<Button>();
        btn.onClick.AddListener(Salto);
    ...
    void Update()
    {
        ...
        entradaX = moveActionToUse.action.ReadValue<Vector2>().x;
#endif
#if UNITY_STANDALONE
